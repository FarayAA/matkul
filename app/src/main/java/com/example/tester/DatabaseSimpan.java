...
public class DatabaseSimpan extends AsyncTask <String, Void, String> {
    AlertDialog dialog;
    Context context;
    public Boolean login = false;

    public DatabaseSimpan(Context context){
    ...
    protected String doInBackground(String... voids) {
        ...
        String connstr = "http://nurchim.000webhostapp.com/simpan.php";
